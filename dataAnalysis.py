...
def Analysis(flowAtPoint, day,  start, end, a_start, a_type):
...
for i in range(0, 2): 
    ...
    print start
    print end
    print (flowAtPoint [day, start:end, :])
    attack_points_list, attack_type_list = Analysis (flowAtPoint, day, start, end, 0.20,  "additive")
